...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ParSee.datetime'
        db.delete_column('pars_parsee', 'datetime')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ParSee.datetime'
        raise RuntimeError("Cannot reverse this migration. 'ParSee.datetime' and its values cannot be restored.")
