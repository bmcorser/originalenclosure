...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ParSeeRun'
        db.create_table('pars_parseerun', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')()),
            ('end', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('pars', ['ParSeeRun'])

        # Adding model 'ParSee'
        db.create_table('pars_parsee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('run', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parsees', to=orm['pars.ParSeeRun'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('par', self.gf('django.db.models.fields.related.ForeignKey')(related_name='parsees', to=orm['pars.Par'])),
            ('result', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=3)),
        ))
        db.send_create_signal('pars', ['ParSee'])


        # Changing field 'Par.slug'
        db.alter_column('pars_par', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=204))

    def backwards(self, orm):
        # Deleting model 'ParSeeRun'
        db.delete_table('pars_parseerun')

        # Deleting model 'ParSee'
        db.delete_table('pars_parsee')


        # Changing field 'Par.slug'
        db.alter_column('pars_par', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=1000000))
    ...
    models = {
        'pars.image': {
            ...
            'seen': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 23, 0, 0)', 'null': 'True'}),
