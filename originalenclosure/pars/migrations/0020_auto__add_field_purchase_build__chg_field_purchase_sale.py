...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Purchase.build'
        db.add_column('pars_purchase', 'build',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 12, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Purchase.build'
        db.delete_column('pars_purchase', 'build')


        # Changing field 'Purchase.sale'
        db.alter_column('pars_purchase', 'sale', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 12, 0, 0)))
    ...
    models = {
        'pars.image': {
            ...
            'seen': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 12, 0, 0)', 'null': 'True'}),
        ...
        'pars.purchase': {
            ...
            'build': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'f98a4039f42c4d46b4627ed3ba98b323'", 'max_length': '32', 'primary_key': 'True'})
        }
    }
